...
for the detection of high redshift supernovae (SNe) out to $z\sim 3$. We
propose to capitalize on this unique asset by searching the HFF data and triggering ToO follow-up for SNe of interest. We expect to discover $\sim 50$ new SNe over the entire 3-year program, including $\sim 5$ SNe Ia at $z>1.5$ and $\sim 10$ SNe Ia at $z>0.5$ with strong lensing magnification. During the first 1 year of the HFF program we have discovered 21 new SNe. These samples are small but special: the high-$z$ SN Ia set has unique leverage for testing SN Ia progenitor models through the delay time distribution while the lensed SNe Ia offer a chance to
validate cluster mass models by directly measuring the lensing magnification.
We will also be able to extend core-collapse SN rate measurements for the
first time beyond $z\sim 1$. This follow-up program provides the spectroscopic
information necessary to unlock the science potential of these SNe.}
...
\AwardedNights{VLT}{20.2h awarded in P92--P93.}
...
\FutureNights{UT2}{$\sim$ 15 h in total (P96--P97)}
...
\SpecialRemarks{This proposal is part of a larger collaborative effort,
involving a dedicated 40-orbit HST program (PID 13386, PID 13790, PI Rodney) to improve 
the characterisation of candidate SNe discovered in the Hubble Frontier 
Fields. Some of the spectroscopy could 
...
\ScientificRationale{Over the past decade, the deep HST Treasury surveys (GOODS, CANDELS, CLASH) 
...
Dahl\'en et al.\ 2008, ApJ, 681, 462). The ongoing HFF
...
magnify fluxes by about a factor of 2, making it easier to detect distant 
...
\medskip\noindent
As the HFF HST data are obtained, we are searching for SNe at all redshifts
-- 840 HST orbits in total at the end of the program. We also search for SNe in supplemental imaging. We have already been awarded 40 HST orbits for ToO follow-up to observe SN light curves (PID 13386, PID 13790, PI Rodney). 

%: the 
%direct imaging observations from 140 HST orbits in the 
%``Grism Lens-Amplified Survey from Space" program (GLASS; PID 13459, PI Treu).
%, and 
%in about 80 hours of ground-based NIR imaging from the VLT with HAWK-I 
%(PID 092.A-0472, PI Brammer) ZZZ UPDATE TO THIS?. 
...
%of explosion (Livio, arXiv:astro-ph/0005344; Maoz \& Mannucci 2012,
...
\medskip\noindent
Volumetric SN Ia rates provide important constraints on the progenitor.  
...
see Figure~1).  
%Previous surveys have collectively measured the SN Ia rate history to 
%$z \approx 2$.  As shown in Figure~1, many viable models fit the measured
%rates at $z < 1$.  However, these models begin to diverge at $z > 1$;
%The high-$z$ regime has the most leverage for discriminating models. 
%Unfortunately this redshift range is currently starved for 
%statistics, with only 11 at $z > 1.5$ from previous HST-SN surveys 
%(Dahl\'en et~al.\ 2008).  
It is here that the HFFs will have the greatest impact, adding about 5 
...
of SN Ia rates to $z
\approx 2.5$, yielding improved constraints on SN Ia progenitor
models.  A secondary goal is to build a sample of about 10 lensed
...
We expect to find $\sim 10$ magnified SNe Ia behind the HFF
...
direct measurement of the lensing magnification (Patel et al., 2014, ApJ, 786, 9). The precision of these SN Ia magnification measures will be on par with the magnification predictions available from existing mass models. Agreement between the SNe and the mass models will provide an important validation of the models. Any disagreement can provide interesting insights into the local clumpiness of the dark matter halo.
...
and catalogs
  \smallskip\\
Li, Hjorth \& Wojtak, 2014, ApJ, submitted (arXiv:1409.3567):
...
\TargetNotes{
The targets will be in the clusters of galaxies 
MACS0416 (RA(J2000) = 04:16:08.4, Dec(J2000) = $-24$:04:27.7),
MACS1149 (RA(J2000) = 11:49:36.3, Dec(J2000) = $+22$:23:50.7)
%Abell S1063 (RA(J2000) = 22:48:44.4, Dec(J2000) = $-44$:31:48.5), 
%Abell 370 (RA(J2000) = 02:39:52.4, Dec(J2000) = $-01:$34:36.5),
or their flanking fields a few arcmin away. Other clusters may
be observed
% by GLASS and
from the ground and will also provide rare events.
